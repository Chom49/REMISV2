...
<div class="space-y-6 max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('tenant.settings.profile') }}" class="p-6 space-y-5">
            @csrf
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('tenant.settings.password') }}" class="p-6 space-y-5">
            @csrf
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <form method="POST" action="{{ route('tenant.settings.notifications') }}" class="p-6 space-y-4">
            @csrf
            ...
            <div class="flex items-center justify-between gap-4 py-2">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Get notified when your rent is coming due.</p>
                </div>
            ...
            <div class="flex items-center justify-between gap-4 py-2">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Get notified when a payment becomes overdue.</p>
                </div>
            ...
            <div class="flex items-center justify-between gap-4 py-2">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-0.5">Get notified 30 days before your lease expires.</p>
                </div>
...
function toggleNotif(key) {
    ...
    document.getElementById('toggle-' + key).style.background = on ? '#40916c' : '#d1d5db';
